...
class WithoutCurriculumLearning30Hz(BaseRLAviary):
    ...
    def reset(self,
        ...
        self.INIT_XYZS = np.array([[*self._random_cylindrical_positions(outer_radius=2, cylinder_height=2, mode='inside')]])
